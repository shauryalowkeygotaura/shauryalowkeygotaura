...
# Shaurya Vardhan Shandilya

**Founder-engineer · Full-Stack + AI**

Building autonomous AI systems that run real businesses, not demos.
...
[![GitHub](https://img.shields.io/badge/GitHub-shauryalowkeygotaura-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/shauryalowkeygotaura)
...
![VAPI](https://img.shields.io/badge/VAPI-10B981?style=flat-square&logoColor=white)
...
![Neon Postgres](https://img.shields.io/badge/Neon_Postgres-00E5CC?style=flat-square&logo=postgresql&logoColor=white)
...
| **[philosopher-pipeline](https://github.com/shauryalowkeygotaura/philosopher-pipeline)** | Autonomous Instagram Reel factory. Cron fires, AI picks a quote, cinematic voiceover plus video, auto-posts. No human in the loop. `Python · edge-tts · FFmpeg` |
| **[brand-launchpad](https://github.com/shauryalowkeygotaura/brand-launchpad)** | One command to a full brand launch: positioning, hero line, 30-day calendar, content system. 12 files in one run. `Claude Code Skill` |
| **[abyss-protocol](https://github.com/shauryalowkeygotaura/abyss-protocol)** | Procedural terminal dungeon crawler, hand-built roguelike generation from scratch. `Python` |
